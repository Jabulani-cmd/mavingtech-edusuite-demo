      ...
      content: (
        <div className="space-y-4">
          <p className="text-sm leading-relaxed">
            MavingTech High School Management System is a comprehensive web-based platform designed to manage all aspects of school operations. The system serves five types of users: <strong>Administrators</strong>, <strong>Bursars/Finance Staff</strong>, <strong>Teachers</strong>, <strong>Students</strong>, and <strong>Parents</strong>.
          </p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Complete guide for the MavingTech High School Management System</p>
        </div>
