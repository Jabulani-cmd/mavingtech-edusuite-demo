                ...
                {editingId ? (
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Auto-generated by the system. Cannot be changed here.
                    </p>
                  </div>
                ) : (
                  <div className="space-y-1">
                    ...
                    <div className="rounded-md border border-dashed bg-muted/40 px-3 py-2 text-sm text-muted-foreground">
                      Auto-generated on save (e.g. <code>first.last@{STAFF_EMAIL_DOMAIN}</code>). A temporary password is issued and the staff member must change it on first login.
                    </div>
                  </div>
                )}
                <div className="space-y-1">
