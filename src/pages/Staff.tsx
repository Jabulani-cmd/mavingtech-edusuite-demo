        ...
        <section className="py-12">
          <div className="container max-w-4xl">
            <motion.div initial={{ opacity: 0, scale: 0.98 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}>
              <img src={groupPhoto} alt="MavingTech High School Staff" className="w-full rounded-xl shadow-maroon object-cover" style={{ aspectRatio: "16/9" }} />
              <p className="mt-3 text-center text-sm text-muted-foreground italic">MavingTech High School Staff</p>
            </motion.div>
          </div>
        </section>
      )}
